...
#old models
STUDENT_OLD_ENGLISH = joblib.load(os.path.join(current_file_path, 'student_models', 'old_models', 'logistic_regression_model_eng.pkl'))
STUDENT_OLD_MATH = joblib.load(os.path.join(current_file_path, 'student_models', 'old_models', 'logistic_regression_model_math.pkl'))
STUDENT_OLD_SCIENCE = joblib.load(os.path.join(current_file_path, 'student_models', 'old_models', 'logistic_regression_model_sci.pkl'))
